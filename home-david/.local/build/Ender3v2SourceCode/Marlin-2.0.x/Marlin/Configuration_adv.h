...
//#define LCD_SHOW_E_TOTAL
  ...
  /* DWDchg: SDCARD_SORT_ALPHA
   * =========================
   * To sem zakomentiral, ker mi ni ok da je po abecedi...
   * Sem pa izbrisal vse dirrektroije ne SD, ker sem nekje prebral,
   * da se ti dve stvari izključujeta.
   * !! POPRAVEK !!
   * moral sem dati nazaj, ker so se izbrali drugi fili!!!!!
  */
