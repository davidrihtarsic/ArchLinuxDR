...
#define Icon_Frame        0xFE29      // DWDchg: Dark Orange frame - za okvirček kjer je kurzor
#define Color_Yellow      0xFF0F
#define Color_SkyBlue     0x0EFF      // DWDchg: Mach SkyBlue theme on CREALITY
...
#define Rectangle_Color   Icon_Frame  // DWDchg: SubMenu Cursor (default color: 0xEE2F)  
#define Percent_Color     0xFE29      // Percentage color
#define BarFill_Color     0x10E4      // Fill color of progress bar
#define Select_Color      0xFA0B      // Selected color 0x33BB  
